...
cover: true
date: 2021-01-25 22:20:51
mathjax: true
top_meta: true
bottom_meta: true
headimg: https://cdn.jsdelivr.net/gh/kumi123/CDN2/66.jpg
tags:
  - 数据库
  - Mysql
categories:
...
在上一篇文章 [看完你就应该能明白的悲观锁和乐观锁 ](https://mp.weixin.qq.com/s?__biz=MzU2NDg0OTgyMA==&mid=2247484531&idx=1&sn=aca8142c1ca387ad276f0d2956a7e2c1&chksm=fc45f980cb32709667c1440b55ee6134437f6344dfd56ad1808ab36cd089b2da62b9c97cf9eb&token=1578492558&lang=zh_CN#rd)中我们已经学习到了什么是悲观锁和乐观锁、悲观锁和乐观锁的实现、优缺点分别是什么。其中乐观锁的实现之一 CAS 算法中提到了一个自旋锁的概念，为了全面理解 CAS 算法就首先需要了解一下`自旋锁` 是什么，自旋锁的适用场景和优缺点分别是什么，别着急，下面为你一一列举。
